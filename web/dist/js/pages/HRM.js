...
function updateInfo(obj){
    ...
    $('#update_employeeName').val(tds.eq(1).text());
    $('#update_employeeSex').val(tds.eq(2).text());
    $('#update_employeeSfzh').val(tds.eq(3).text());
    $('#update_employeeAge').val(tds.eq(4).text());
    $('#update_employeeAddress').val(tds.eq(5).text());
    $('#update_employeeTelephone').val(tds.eq(6).text());
    $('#update_positionName').val(tds.eq(7).text());
    $('#update_enterTime').val(tds.eq(8).text());
