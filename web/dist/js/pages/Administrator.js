...
function updateInfo(obj){
    ...
    $('#update_username').val(tds.eq(0).text());
    $('#update_password').val(tds.eq(1).text());
    $('#update_realname').val(tds.eq(2).text());
    $('#update_telephone').val(tds.eq(3).text());
    $('#updateAdministrator').modal('show');
}
function deleteInfo(obj){
    var tds=$(obj).parent().parent().find('td');
    $('#delete_username').val(tds.eq(0).text());
    $('#deleteAdministrator').modal('show');
}